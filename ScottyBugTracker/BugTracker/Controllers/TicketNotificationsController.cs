...
namespace BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Created,Subject,NotificationBody,TicketId,RecipientId")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Created,Subject,NotificationBody,TicketId,RecipientId")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
